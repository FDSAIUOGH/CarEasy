...
App = {
    ...
    buttonContent+=
        ...
        +'<p class="normal">车主：<samp id="publisherPublishAge">'+result[3]+'</samp></p>'
        +'<p class="normal">车牌号：<samp id="ISBN">'+result[4]+'</samp></p>'
        +'<p class="normal">购车年份：<samp id="pages">'+result[8].toString()+'</samp></p>'
        +'<p class="normal">出租状态：<samp id="status">'+ result[7] +'</samp></p>'
        +'<p class="normal">出租次数：<samp id="borrowNums">'+borrowNum+'</samp></p>'
